...
public class Student {
    ...
    Student(){}
    Student(String n,String un,String p,int[] arr,int a){
        name=n;
        username=un;
        password=p;
    ...
    public void regStudent(){
        try{
            ...
            stm.executeUpdate("insert into student(name,username,password,age) values('"+name+"','"+username+"','"+password+"','"+age+"');");
    ...
    public void showstudent(){
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/umsystem","root","tharindu");
            Statement stm=con.createStatement();
            ResultSet rs=stm.executeQuery("select * from student where username='"+uname+"' and password='"+pword+"'");
